...
app.add_url_rule('/reorder_albums',view_func=reorder_albums,methods=["POST"])
app.add_url_rule('/update_photo_info',view_func=update_photo_info,methods=["POST"])
app.add_url_rule('/update_album_info',view_func=update_album_info,methods=["POST"])
app.add_url_rule('/set_active_album',view_func=set_active_album,methods=["POST"])
app.add_url_rule('/search',view_func=picture_search,methods=["POST"])
